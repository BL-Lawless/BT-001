...
const run=(async()=>{
  ...
  assert(source.includes("signalEngineRegistry.accepts(output)"));assert(source.includes("engineId:output.engineId,engineVersion:output.engineVersion,publicationGeneration:generation"));
