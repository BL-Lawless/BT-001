...
- `presentation/gradCalculatorModule.js`: isolated three-tab GR UI with persistent ownership, Exit ladder reconciliation, unique Protection recreate identities, Calculator-style preflight, executed Entry tracking, separate Master SL, and strict section Reads.
