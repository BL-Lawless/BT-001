...
- `presentation/gradCalculatorModule.js`: isolated three-tab GR UI with direct Entry Flush, open-orders-only Entry Read, levels SVG toolbar icon, no-offset chart labels, universal Master SL display, persistent ownership, and Calculator-style preflight.
