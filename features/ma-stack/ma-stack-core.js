(() => {
  ...
  const SCORE_ATR = Object.freeze({stackSpread:4.0,expansionOffset:0.20,expansionRange:0.60,slopeMove:0.30,acceleration:0.20,tightStack:1.0,releaseOrigin:1.20,releaseDelta:0.15,flattenDelta:-0.10,flatSlope:0.08,preCompression:1.50,priceProximity:0.25});
    ...
    function unavailable(reason,provisional=false){
      ...
      return {available:false,unavailableReason,state:"mixed",icon:"~",strength:0,alignment:0,quality:0,setup:0,provisional:!!provisional,atr:null,adx:null,adxPrevious:null,plusDi:null,minusDi:null,adxDirection:null,adxCrossed:false,adxTag:{glyph:"−",tone:"grey",direction:null,crossed:false},spreadPct:null,spreadAtr:null,spreadScore:null,spreadLabel:"Unavailable",spreadCondition:"unavailable",maPair:"No fresh event",maEvent:null,priceEvent:"None",maPairAge:null,priceEventAge:null,blinkIntent:"none",blinkReason:"Unavailable",title:`State: Unavailable\nStack direction: mixed\nStack Alignment: 0%\nStrength: 0%\nQuality: 0%\nHigher TF agreement: mixed / unavailable\nSpread: Unavailable\nSlope agreement: unavailable\nPhase: ${unavailableReason}\nMA Pair: No fresh event\nPrice-MA: None\nMA-pair age: -\nPrice-MA age: -\nBlink intent: none\nBlink reason: Unavailable`};
    }
    function classify(rows,debugCtx,snapshot){
      ...
      return {available:true,unavailableReason:null,state,icon,strength,alignment,quality,title,phase,setup,provisional,atr:currentAtr,adx:volatilitySnapshot.adx,adxPrevious:volatilitySnapshot.adxShadow,plusDi:volatilitySnapshot.plusDi,minusDi:volatilitySnapshot.minusDi,adxDirection:volatilitySnapshot.adxDirection,adxCrossed:volatilitySnapshot.adxCrossed,adxTag:volatilitySnapshot.adxTag,spreadPct,spreadAtr,spreadScore:structuredSpreadScore,spreadLabel,spreadCondition,maPair,maEvent,priceEvent:priceMa,maPairAge:maEvent?maEvent.age:null,priceEventAge:priceEvent?priceEvent.age:null,blinkIntent:blink.intent,blinkReason:blink.reason,blinkEvent,eventDisplay:blink.display,rank};
    }
