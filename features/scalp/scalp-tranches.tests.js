...
async function run(){
  ...
  const logs=[],runtime=load(["features/scalp/config.js","features/scalp/calculations.js","features/scalp/tranche-book.js","features/scalp/exit-decisions.js","features/scalp/core/logger.js","features/scalp/core/signal-detector-core.js","features/scalp/signal-detector.js","features/scalp/state-machine.js"],{
  ...
  boostedLong.pslOrderId=null;await rankEngine.ensureTrancheProtection(boostedLong,{psl:true,tp:false});const firstRebuildClientId=boostedLong.pslClientId;boostedLong.pslOrderId=null;await rankEngine.ensureTrancheProtection(boostedLong,{psl:true,tp:false});assert.notEqual(boostedLong.pslClientId,firstRebuildClientId,"back-to-back rebuilds must submit distinct PSL client IDs");
