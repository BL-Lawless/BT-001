...
async function run(){
  ...
  const scoreEvent={source:"1m",eventType:"CROSS",direction:"LONG"},scoreRow={time:60,close:100.5},scoreAnalysis=(separation,previousFastSlope)=>({s:100,f:100+separation,range:1,separation,fastSlope:.08,previousFastSlope,slowSlope:.02});
