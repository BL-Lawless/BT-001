(() => {
  ...
  root.config=Object.freeze({
    version:"1.0.0",consumerId:"BT001_SCALP",configKey:"bt001_scalp_config_v1",windowKey:"bt001_scalp_window_v1",sessionKey:"bt001_scalp_active_session_v1",autoLossKey:"bt001_scalp_auto_loss_v1",
    ...
    defaults:Object.freeze({direction:"ANY",source:"1m",entryType:"ANY",minimumRank:0,lot:"0.000",target:"5.0",tpDelta:"0",tpDriver:"NET_TARGET",stop:"3.0",slDelta:"0",slDriver:"NET_SL",mode:"SINGLE",cooloffMinutes:1,autoEntryEnabled:false,autoTradingEnabled:false,maxConcurrentAutoPositions:1,maxDailyAutoLossUsd:25}),
