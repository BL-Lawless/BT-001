(() => {
  ...
  root.config=Object.freeze({
    ...
    defaults:Object.freeze({direction:"ANY",source:"1m",entryType:"ANY",minimumRank:0,lot:"0.000",target:"5.0",tpDelta:"0",tpDriver:"NET_TARGET",stop:"3.0",slDelta:"0",slDriver:"NET_SL",mode:"SINGLE",cooloffMinutes:1,maxConcurrentAutoPositions:1,maxDailyAutoLossUsd:25}),
