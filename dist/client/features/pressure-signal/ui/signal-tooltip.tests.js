...
cases.bPublishedEvidence=["setupEvidence","triggerEvidence","entryCondition","data","readinessBreakdown"].every(key=>Object.prototype.hasOwnProperty.call(bOutput.comparisonDiagnostics,key));
cases.bReadinessBreakdown=["Readiness breakdown: gates","trigger","setup","current entry","bonus","chase dampener"].every(label=>bText.includes(label));
